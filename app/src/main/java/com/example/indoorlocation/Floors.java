...
public class Floors extends Activity {
    ...
    public void onCreate(Bundle saveInstanceState) {
        ...
        addFloor=(Button) findViewById(R.id.addfloor);
        ...
        floorslist = (ListView) findViewById(R.id.floorslist);
        arrayAdapter = new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1,buildings);

        floorslist.setAdapter(arrayAdapter);
        ...
        floorslist.setOnTouchListener(touchListener);
    }
